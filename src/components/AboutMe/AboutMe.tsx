...
export const AboutMe  = () => {
  return (
    ...
    <Paragraph>Hi, I'm Arun. I have around 24 years of experience in various roles which includes testing/UAT, Operations, Product Management
     ...
     <Paragraph> I have co-founded a fintech 'Orbital' with 4 other partners in 2018 and helped to build it into a sucessful business with 100+ employees resulting in a 
      pre-series A funding of £5M in Q2 2023. I have to leave the business due to difference of opinion with other 
